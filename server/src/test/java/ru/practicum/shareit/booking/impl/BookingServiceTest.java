...
class BookingServiceTest {
    ...
    void test4_1_getAllUser_userNotFound() throws ModelNotExitsException {
        ...
        Mockito
                .when(userServise.findById(1L))
                .thenThrow(ModelNotExitsException.class);
        assertThrows(UserNotFoundExteption.class, () -> bookingServise.getAllUser(1L, null));
    }
    ...
    void test4_3_getAllUser_withOutFromSize() throws ModelNotExitsException {
        ...
        bookingServise.getAllUser(1L, null);
    ...
    void test4_4_getAllUser_withFromSize() throws ModelNotExitsException, IncorrectPageValueException {
        ...
        bookingServise.getAllUser(1L, PageParam.createPageable(0, 5));
    ...
    void test5_7_testGetAllUser_ALL() throws UnknownStateException, ModelNotExitsException, IncorrectPageValueException {
        ...
        Mockito
                .when(bookingRepository.findByBooker_IdOrderByStartDesc(pageable, 1L))
                .thenReturn(new PageImpl<>(List.of(BOOKING1_USER2_ITEM1_WAITING)));
        bookingServise.getAllUser(1L, BookingState.ALL, PageParam.createPageable(0, 5));
        Mockito.verify(bookingRepository, Mockito.times(1))
                .findByBooker_IdOrderByStartDesc(pageable, 1L);
    }
    ...
    void test5_3_testGetAllUser_WAITING() throws UnknownStateException, UserNotFoundExteption {
        bookingServise.getAllUser(1L, BookingState.WAITING, null);
        Mockito.verify(bookingRepository, Mockito.times(1))
    ...
    void test5_4_testGetAllUser_CURRENT() throws UnknownStateException, UserNotFoundExteption {
        bookingServise.getAllUser(1L, BookingState.CURRENT, null);
        Mockito.verify(bookingRepository, Mockito.times(1))
    ...
    void test5_5_testGetAllUser_REJECTED() throws UnknownStateException, UserNotFoundExteption {
        bookingServise.getAllUser(1L, BookingState.REJECTED, null);
        Mockito.verify(bookingRepository, Mockito.times(1))
    ...
    void test5_6_testGetAllUser_FUTURE() throws UnknownStateException, UserNotFoundExteption {
        bookingServise.getAllUser(1L, BookingState.FUTURE, null);
        Mockito.verify(bookingRepository, Mockito.times(1))
    ...
    void test6_1_getAllOwner_userNotFound() throws ModelNotExitsException {
        Mockito
                .when(userServise.findById(1L))
                .thenThrow(ModelNotExitsException.class);
        assertThrows(UserNotFoundExteption.class, () -> bookingServise.getAllOwner(1L, defaultPageble, BookingState.FUTURE));
    }
    ...
    void test6_2_getAllOwner_PAST() throws UnknownStateException, UserNotFoundExteption, IncorrectPageValueException {
        ...
        bookingServise.getAllOwner(1L, defaultPageble, BookingState.PAST);
        Mockito.verify(bookingRepository, Mockito.times(1))
                .findOwnerPast(1L, defaultPageble, LocalDateTime.now().toEpochSecond(ZoneOffset.UTC));
    }

    @Test
    void test6_3_getAllOwner_WAITING() throws UnknownStateException, UserNotFoundExteption {
        Mockito
                .when(bookingRepository.findByOwnerIdAndStatus(1L, defaultPageble, BookingStatus.WAITING))
                .thenReturn(Page.empty());
        bookingServise.getAllOwner(1L, defaultPageble, BookingState.WAITING);
        Mockito.verify(bookingRepository, Mockito.times(1))
                .findByOwnerIdAndStatus(1L, defaultPageble, BookingStatus.WAITING);
    }

    @Test
    void test6_4_getAllOwner_CURRENT() throws UnknownStateException, UserNotFoundExteption {
        Mockito
                .when(bookingRepository.findOwnerCurrent(1L, defaultPageble,
                        LocalDateTime.now().toEpochSecond(ZoneOffset.UTC)))
                .thenReturn(Page.empty());
        bookingServise.getAllOwner(1L, defaultPageble, BookingState.CURRENT);
        Mockito.verify(bookingRepository, Mockito.times(1))
                .findOwnerCurrent(1L, defaultPageble,
                        LocalDateTime.now().toEpochSecond(ZoneOffset.UTC));
    }
    ...
    void test6_5_getAllOwner_REJECTED() throws UnknownStateException, UserNotFoundExteption {
        Mockito
                .when(bookingRepository.findByOwnerIdAndStatus(1L, defaultPageble, BookingStatus.REJECTED))
                .thenReturn(Page.empty());
        bookingServise.getAllOwner(1L, defaultPageble, BookingState.REJECTED);
        Mockito.verify(bookingRepository, Mockito.times(1))
                .findByOwnerIdAndStatus(1L, defaultPageble, BookingStatus.REJECTED);
    }

    @Test
    void test6_6_getAllOwner_FUTURE() throws UnknownStateException, UserNotFoundExteption {
        Mockito
                .when(bookingRepository.findOwnerFuture(1L, defaultPageble, LocalDateTime.now().toEpochSecond(ZoneOffset.UTC)))
                .thenReturn(Page.empty());
        bookingServise.getAllOwner(1L, defaultPageble, BookingState.FUTURE);
        Mockito.verify(bookingRepository, Mockito.times(1))
                .findOwnerFuture(1L, defaultPageble, LocalDateTime.now().toEpochSecond(ZoneOffset.UTC));
    }
    ...
    void test6_7_getAllOwner_userNotFound() throws ModelNotExitsException {
        ...
        assertThrows(UserNotFoundExteption.class, () ->
                bookingServise.getAllOwner(1L, PageParam.createPageable(null, null)));
    }
    ...
    @Test
    void test6_9_getAllUser_withOutFromSize() throws ModelNotExitsException, IncorrectPageValueException {
        Mockito
                .when(userServise.findById(1L))
                .thenReturn(USER_ID1);
        Mockito
    ...
    void test6_10_getAllUser_withFromSize() throws ModelNotExitsException, IncorrectPageValueException {
        ...
        Mockito
                ...
                .thenReturn(new PageImpl<>(List.of(BOOKING1_USER2_ITEM1_WAITING)));
        bookingServise.getAllOwner(1L, PageParam.createPageable(0, 5));
        Mockito.verify(bookingRepository, Mockito.times(1))
    ...
    void test6_11_testGetAllUser_ALL() throws UnknownStateException, ModelNotExitsException {
        ...
        bookingServise.getAllOwner(1L, pageable, BookingState.ALL);
        Mockito.verify(bookingRepository, Mockito.times(1))
                .findOwnerAll(pageable, 1L);
    }
